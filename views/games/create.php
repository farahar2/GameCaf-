        ...
        <form action="/games" method="POST" class="space-y-6" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       placeholder="Ex: Catan, Dixit, 7 Wonders..."
                       required
            ...
            <div>
                ...
                <textarea name="description"
                          rows="3"
                          placeholder="Décrivez le jeu en quelques mots..."
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="difficulty"
                        ...
                        ?>
                            <option value="<?= $val ?>"
                                <?= ($_POST['difficulty'] ?? 'medium') === $val ? 'selected' : '' ?>>
                                <?= $label ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="number"
                           name="min_players"
                           value="<?= htmlspecialchars($_POST['min_players'] ?? '2') ?>"
                           min="1" max="20"
                           required
                ...
                <div>
                    ...
                    <input type="number"
                           name="max_players"
                           value="<?= htmlspecialchars($_POST['max_players'] ?? '4') ?>"
                           min="1" max="20"
                           required
                           class="w-full bg-surface-container-low border-none rounded-xl px-4 py-4 focus:ring-2 focus:ring-primary/30 text-center font-bold text-on-surface"/>
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           name="duration"
                           value="<?= htmlspecialchars($_POST['duration'] ?? '30') ?>"
                           min="5" max="600"
                           required
                           class="w-full bg-surface-container-low border-none rounded-xl px-4 py-4 focus:ring-2 focus:ring-primary/30 text-center font-bold text-on-surface"/>
                </div>
            ...
            <div>
                ...
                <p class="text-xs text-on-surface-variant mt-1 flex items-center gap-1">
                    ...
                    Lien vers une image du jeu (optionnel)
                </p>
            </div>
            ...
            <div class="flex items-center justify-between bg-surface-container-low rounded-xl p-4">
                <div>
                    ...
                    <p class="text-xs text-on-surface-variant">Le jeu est visible et réservable par les clients</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox"
                           name="is_available"
                           value="1"
                           <?= ($_POST['is_available'] ?? '1') === '1' ? 'checked' : '' ?>
                           class="sr-only peer"/>
