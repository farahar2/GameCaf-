...
CREATE TABLE sessions (
    ...
    table_id INT NOT NULL,
    user_id INT NOT NULL COMMENT 'Client de la session',
    started_by INT DEFAULT NULL COMMENT 'Admin qui a lancé',
    start_time DATETIME NOT NULL,
    end_time DATETIME DEFAULT NULL,
    duration INT DEFAULT NULL COMMENT 'Durée réelle (auto)',
